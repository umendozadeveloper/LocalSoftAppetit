<?php
          ...
          echo "<title>Registrar bebida</title>";
          ?>
...
<script>
    var arregloCompuesto = [];
        ...
        <?php
        if(!empty($_SESSION['msjRegistrarVino'])){
            
            //echo "<script>swal('".$_SESSION['msjRegistrarVino'][0]."');</script>";
            echo "<script>swal('" . $_SESSION['titulo'] . "','" . $_SESSION['msjRegistrarVino'][0] . "','" . $_SESSION['tipo'] . "');</script>";
            /*****Limpio variables de sesion****/
            $_SESSION['msjRegistrarVino'] = null;
            unset($_SESSION['msjRegistrarVino']);
        ...
        ?>
            ...
            <form action="Validaciones_Lado_Servidor/Validar_AgregarVino.php" method="POST" name="form" enctype="multipart/form-data" id="form">
                
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-offset-1 col-lg-10">
                        <table class="encabezadoTabla">
                            <td class="tdEncabezadoTabla">
                                <div><h4><center><label class="textoEncabezadoTabla">Registrar Bebida</label></center></h4></div>
                            </td>
                        </table>
                    </div>
                        ...
                        <tr>
                            <td width="20%"><div class="etiquetas2">Nombre del vino</div></td>
                                ...
                                {
                                    echo "<td><div class='campos col-xs-12 col-sm-12 col-md-12 col-lg-12 input-group'><input type='text' id='txtNombreVino'  name='txtNombreVino'    class='form-control' value=''></div></td>";
                                }
                                else{
                                    $valor = $_SESSION['valNombre'];
                                    echo "<td><div class='campos col-xs-12 col-sm-12 col-md-12 col-lg-12 input-group'><input type='text' id='txtNombreVino'  name='txtNombreVino'    class='form-control' value='$valor'></div></td>";
...
if (!isset($_SESSION['valArrayProductos']) && (empty($_SESSION['valArrayProductos']))) {
    ...
    $_SESSION['valArrayProductos'] = null;
                ...
                <?php
                    ...
                    <option value="1">
                        Exento
                                ...
                                {
                                    echo "<td><div class='campos col-xs-12 col-sm-12 col-md-12 col-lg-12 input-group'><input type='text' id='txtIVA'  name='txtIVA'    class='form-control' value=''></div></td>";
                                }
                                else{
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5">
                        ...
                        <tr>
                            <td width="20%"><div class="etiquetas2">Precio por botella</div></td>
                                ...
                                <?php
                                if(!isset($_SESSION['valPrecioBotella']) && (empty($_SESSION['valPrecioBotella'])))
                                {
                                    echo "<td><div class='campos col-xs-12 col-sm-12 col-md-12 col-lg-12 input-group'><input type='text' id='txtPrecioBotella'  name='txtPrecioBotella'    class='form-control' value=''></div></td>";
                                }
                                else{
                                    $valor = $_SESSION['valPrecioBotella'];
                                    echo "<td><div class='campos col-xs-12 col-sm-12 col-md-12 col-lg-12 input-group'><input type='text' id='txtPrecioBotella'  name='txtPrecioBotella'    class='form-control' value='$valor'></div></td>";
                        ...
                        <tr>
                            <td width="20%"><div class="etiquetas2">Precio por copa</div></td>
                                ...
                                <?php
                                if(!isset($_SESSION['valPrecioCopa']) && (empty($_SESSION['valPrecioCopa'])))
                                {
                                    echo "<td><div class='campos col-xs-12 col-sm-12 col-md-12 col-lg-12 input-group'><input type='text' id='txtPrecioCopa'  name='txtPrecioCopa'    class='form-control' value=''></div></td>";
                                }
                                else{
                                    $valor = $_SESSION['valPrecioCopa'];
                                    echo "<td><div class='campos col-xs-12 col-sm-12 col-md-12 col-lg-12 input-group'><input type='text' id='txtPrecioCopa'  name='txtPrecioCopa'    class='form-control' value='$valor'></div></td>";
        ...
        <tr>
            <th class="" colspan="4" style="text-align: center;color: white; height: 10%;">Seleccionar menú</th>
        </tr>
        <tr>
            <th class=""style="">Nombre del menú</th>
...
<!------------------------------------------------------------------------------------------------>               
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-offset-1 col-lg-10" id="DivTablaInsumos" name="DivTablaInsumos">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-offset-1 col-lg-10">
                            ...
                            <div class="etiquetas2">¿Agregar a maridaje?</div>
                                    <div class='campos  '>
                                            <select class="form-control" id='cmbMaridaje' name="cmbMaridaje">
                                                <option value="0">No</option>
                                                <option value="1">Si</option>
                                            </select>
                                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-offset-1 col-lg-10 ocultar " id='tablaMaridaje'>
                    <div style="width: 100%; overflow-x: auto;">
                <table  class="table table-bordered">
                    <thead class="EncabezadoTablaPersonalizada">
        <tr>
            <th colspan="4" style="text-align: center;">Seleccionar alimentos</th>
        </tr>
        <tr>
            <th style="">Nombre del alimento</th>
    ...
    <tbody>
        ...
        foreach($platillos as $v){
                ...
                echo "<td>$v->Nombre</td>";
                echo "<td><center><input type='checkbox' name='platillo$v->ID' id='radioMenu' value='$v->ID'></center></td>";
                if($fila == 2){
                    echo "</tr>";
...
//         
    ...
    $("#cmbMaridaje").change(function (){
        
        if($(this).val()==1){
            $("#tablaMaridaje").removeClass("ocultar");
            $("#tablaMaridaje").addClass("mostrar");
        }
        else{
            $("#tablaMaridaje").removeClass("mostrar");
            $("#tablaMaridaje").addClass("ocultar");
        }
    });
...
//           var id_clasificador = $("#cmbCategoria").val();
//           
//        $.ajax({
//            url: "Validaciones_Lado_Servidor/N_Mostrar_Tabla_Insumos.php",
//            type: 'POST',
//            data: {"id_clasificador": id_clasificador},
//            success: function(data){
//                $("#DivTablaInsumos").html(data);
//            }
//        });
//      });
...
//    }
        ...
        $( "#form" ).validate( {
				...
				messages: {
                                        txtNombreVino: {
						required: "Introducir nombre del vino"
					},
					txtDescripcionCorta: {
