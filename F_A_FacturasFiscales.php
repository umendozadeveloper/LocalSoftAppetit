...
?>
    <form action="Validaciones_Lado_Servidor/Validar_GenerarXml.php" method="POST" enctype="multipart/form-data" id='form'>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-lg-offset-1 col-lg-10 table-responsive">
            <table border="0" style="text-align: center;" >
                ...
                <td><button value="Timbrar" id="Facturar" name="Facturar" onclick="AsignarValoresPost();" class="Timbrar textoOpcionesMenuFacturacion"><span class="glyphicon glyphicon-qrcode" style="font-size:22px; color:#000;"></span> Timbrar</button></td>
                <td><button disabled=""type="button" class="textoOpcionesMenuFacturacion"><span class="glyphicon glyphicon-remove" style="font-size:22px; color:red;"></span> Cancelar</button></td>
...
?>'>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-offset-1 col-lg-10">
            ...
            <div  class="table-responsive Comandas" style="float: left">
                ...
                <div id="ComandasDiv" name="ComandasDiv" style="overflow-y: scroll; height: auto; min-height: 90px;max-height:300px;">
