        ...
        <form action="Validaciones_Lado_Servidor/Validar_AgregarMesas.php" method="POST" name="form" id="form">
            
            
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-offset-1 col-lg-10">
            <table class="encabezadoTabla">
            <td class="tdEncabezadoTabla">
                <div><h4><center><label class="textoEncabezadoTabla">Registrar mesa</label></center></h4></div>
            </td>
            </table>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-offset-1 col-lg-5">
            <table class="table-hover">
                ...
                <?php
                            if(!isset($_SESSION['valNumeroMesa']) && (empty($_SESSION['valNumeroMesa'])))
                                {
                                
                                echo "<td><div class='campos col-xs-12 col-sm-12 col-md-12 col-lg-12 input-group'><input type='text' id='txtNumeroMesa'  name='txtNumeroMesa'  title='Ingresar Datos' class='form-control' value=''></div></td>";
                                }
                                else{
                                    $mesa = $_SESSION['valNumeroMesa'];
                                    echo "<td><div class='campos col-xs-12 col-sm-12 col-md-12 col-lg-12 input-group'><input type='text' id='txtNumeroMesa'  name='txtNumeroMesa'  title='Ingresar Datos' class='form-control' value='$mesa'></div></td>";
            ...
            <tr>                                             
                ...
                <?php
                            if(!isset($_SESSION['valCantidadPersonas']) && (empty($_SESSION['valCantidadPersonas'])))
                                {
                                
                                echo "<td><div class='campos col-xs-12 col-sm-12 col-md-12 col-lg-12 input-group'><input type='text' id='txtCantidadPersonas' name='txtCantidadPersonas'  title='Ingresar Datos' class='form-control' value=''></div></td>";
                                }
                                else{
                                    $cantidad = $_SESSION['valCantidadPersonas'];
                                    echo "<td><div class='campos col-xs-12 col-sm-12 col-md-12 col-lg-12 input-group'><input type='text'  id='txtCantidadPersonas'  name='txtCantidadPersonas'  title='Ingresar Datos' class='form-control' value='$cantidad'></div></td>";
      ...
      <td><div class='campos'><select id="txtUbicacion" class="form-control" name="txtUbicacion">
       ...
       <div class="col-xs-12 col-sm-12 col-md-12 col-lg-offset-1 col-lg-10">
            ...
            <button type="submit" style="float: right;" id="btnAceptar" name="btnMesa" class="btn btn-Bixa btn-ms" >Guardar</button>
                <a href="F_A_ConsultarMesas.php" type="button" class="btn btn-Regresar btn-ms">
                        &larr; Consultar mesas
                </a>
                <br>
                <br>
       </div>
        ...
        <script>
			...
			$( "#form" ).validate( {
				...
				messages: {
						txtNumeroMesa: {
						required: "Por favor capture el número de mesa",
						minlength: "Al menos debe tener un digito",
                                                digits:"Ingresar únicamente números"
					},
					txtCantidadPersonas: {
						required: "Por favor capture la cantidad de personas",
						minlength: "Al menos debe tener un digito",
                                                digits:"Ingresar únicamente números"
					},
                                        txtUbicacion:{
