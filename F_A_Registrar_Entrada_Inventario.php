    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-offset-1 col-lg-10">
        <table class="encabezadoTabla">
            <td class="tdEncabezadoTabla">
                <div><h4><center><label class="textoEncabezadoTabla">Registrar Compras (Entradas)</label></center></h4></div>
            </td>
        </table>
    </div>
     ...
     <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-lg-offset-1 col-lg-10 table-responsive">
            <table border="0" style="text-align: center;" >
                <tr>
                    ...
                    <td>Fecha: </td>
                    <td></td>
                    <td><div align="left"><input class="form-control" type="text" name="txtFecha" id="txtFecha" readonly="" value="<?php echo date('d/m/Y'); ?>" style="width: 42%; text-align: center;"/></div></td>
...
<!--            <thead>
            <tr>
                ...
                <th style="width:1.5%;" class='EncabezadoTablaPersonalizada'>&nbsp;</th>
                <th style="width:11.5%;" class='EncabezadoTablaPersonalizada'><center>Importe</center></th>
                <th style="width:15%;" class='EncabezadoTablaPersonalizada'><center>Almacén</center></th>
                <th style="width:15%;"class='EncabezadoTablaPersonalizada'><center>Concepto</center></th>
