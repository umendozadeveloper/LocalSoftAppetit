        ...
        ?>
            ...
            <form action="Validaciones_Lado_Servidor/N_AgregarAdmin.php" method="POST"  enctype="multipart/form-data" id='form'>
                
                    <div class="col-xs-12 col-sm-12 col-md-offset-1 col-md-10 col-lg-offset-1 col-lg-10">
                        <table class="encabezadoTabla">
                            <td class="tdEncabezadoTabla">
                                <div><h4><center><label class="textoEncabezadoTabla">Registrar administrador</label></center></h4></div>
                            </td>
                        </table>
                    </div>
                ...
                <?php
                    ...
                    <table>
                       ...
                       <tr>
                        ...
                        <tr>
                            <td width="20%"><div class="etiquetas2">Añadir cuenta a mesero</div></td>
                            <td><select name="cmbPrivilegiosM" id="cmbPrivilegiosM" class="input-group form-control">
                                <?php
                                if(!isset($_SESSION['valPrivilegiosMesero']) && (empty($_SESSION['valPrivilegiosMesero'])))
                                {
                    ...
                    <a href='F_A_ConsultarAdmin.php' type="button" class="btn btn-Regresar btn-ms" >
