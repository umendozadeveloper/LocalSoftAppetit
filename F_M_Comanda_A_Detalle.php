...
?>
            ...
            foreach ($comandaPlatillos as $cPlatillos) {
                ...
                if ($cPlatillos->EstadoPedidoDescripcion == "Producto pedido" && $objComanda->IdEstado == 1) {
                    echo "<td><center>"
                    . "<button type='button' class='btn btn-default btn-xs' value=$cPlatillos->ID name='btnComandaPGuardar' data-toggle='tooltip' data-placement='left' title='Guardar cantidad editada del producto'><img src='img/Save.png'></button>"
                    . "<button type='button' class='btn btn-default btn-xs' value=$cPlatillos->ID name='btnComandaP' data-toggle='tooltip' data-placement='left' title='Eliminar producto de la comanda' ><img src='img/Delete.png'></button>"
                    . "<button type='button' class='btn btn-default btn-xs' value=$cPlatillos->ID name='btnComandaPListo' data-toggle='tooltip' data-placement='left' title='Marcar producto como servido' ><img src='img/AcceptBIXA.png'></button>"
                    . "</td>";
                } else {
                    echo "<td></td>";
                }
                    ...
                    <tbody>
                        ...
                        foreach ($comandaVinos as $cVinos) {
                            ...
                            if ($cVinos->EstadoPedidoDescripcion == "Producto pedido") {
                                ...
                                $objVino->ConsultarPorID($cVinos->ID);
...
<!--------------------------------------------------------------------------------------------------------------------------------------->
 <div class="modal fade"   id="VMCocina" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
				<div class="modal-dialog" >
						...
						<div class="modal-header">
							...
							<h4>Se enviará a monitor...</h4>
						</div>
                                    <form action="" method="POST" id="formCocina">
                                        <input id="txt_id_comanda" name="txt_id_comanda" value="<?php echo $idComanda; ?>" class="ocultar">
						<div class="modal-body">
                                                    <?php 
                                                    $platillosPedidos = $objComandaPlatillos->ConsultarPorIdComandaPedido($idComanda);
                                                            if(count($platillosPedidos)>0){
                                                                ?>
                                                            
                                                    <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                                        <table  class="tablesorter table-hover table-bordered tablaConsulta table-responsive " cellspacing="0" width="100%">
                                                            <thead>
                                                                <tr>
                                                                    <th colspan="4">COCINA</th>
                                                                </tr>
                                                                <tr>
                                                            ...
                                                            foreach($platillosPedidos as $pP){
                                                                $objPlatillo->ConsultarPorID($pP->IdPlatillo);
                                                                echo "<tr>";
                                                                echo "<td>$pP->NombrePlatillo</td>";
                                                                echo "<td><img class='imagenesTabla' src='$objPlatillo->Foto'></td>";
                                                                echo "<td>$pP->Cantidad</td>";
                                                                echo "<td>$pP->Comentarios</td>";
                                                                echo "</tr>";
                                                            }
                                                            ?>
                                                                </tbody>
                                                    ...
                                                    $vinosPedidos = $objComandaVinos->ConsultarPorIdComandaPedido($idComanda);
                                                    ...
                                                    <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                                        <table  class="tablesorter table-hover table-bordered tablaConsulta table-responsive " cellspacing="0" width="100%">
                                                            ...
                                                            foreach($vinosPedidos as $vP){
                                                                $objVino->ConsultarPorID($vP->IdVino);
                                                                echo "<tr>";
                                                                echo "<td>$vP->NombreVino</td>";
                                                                echo "<td><img class='imagenesTabla' src='$objVino->Foto'></td>";
                                                                echo "<td>$vP->CantidadCopas</td>";
                                                                echo "<td>$vP->CantidadBotellas</td>";
                                                                echo "<td>$vP->Comentarios</td>";
                                                                echo "</tr>";
                                                            }
                                                            ?>
                                                            </tbody>
                                                    ...
                                                    <input class="ocultar" type="text" name="IdComanda" value="<?php echo $idComanda;?>">
                                                    
                                                </div>

						<div class="modal-footer">
                                                    <br><br>
                                                    <button type="button" id="btnCocina" class="btn btn-Bixa" >Enviar</button>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-offset-1 col-lg-10">
       ...
       <!-- <input type='text'  name='txtNUMCOMANDA' class='ocultar'>
        ...
        ?>
        <input type='text' id='txtIdVenta' name='txtIdVenta' class='ocultar' value="<?php //if(is_null($objVenta->ID)){echo "-1";}else{echo $objVenta->ID; } ?> ">
        -->
        
		
		<?php if($objComanda->Clave=="Abierta"){?>
...
<!--        <a class="btn btn-Regresar"  href="F_M_ConsultarComandas.php">
        ...
        <?php $hayQuPagar='FALSE';?>
         <?php if(count($vinosPedidos)>0 || count($platillosPedidos)>0){?>
        <button id="btnVMCocina" type="button" class="btn btn-Bixa" data-toggle='modal' data-target='#VMCocina'>Enviar a cocina</button>
        ...
        <?php 
         ...
         ?>
        <br><br>
        <input name="txtHayQuePagar" id="txtHayQuePagar" class="ocultar" value="<?php echo $hayQuPagar; ?>"/>
    </div>
        
        
    <script>
        $(document).ready(function() {
//            document.getElementById("btnVMCocina").disabled = true; 
//            $('#btnVMCocina').addClass('ocultar');
            ImprimirTicket();
        });
        ...
        function ImprimirTicket(){
            var IdVenta = document.getElementById("txtIdVenta").value;
            if(IdVenta > 0)
                {
    ...
    <script>
          $("#btnCocina").click(function (){
            ...
            swal({   
		title: '',   
		text: '¿Desea envíar los productos(pedidos) a cocina?',   
		type: 'warning',   
		...
		closeOnCancel: true },
            function(isConfirm){   
                if (isConfirm) {   
//                    $("#formCocina").submit();
                    var IdComanda = document.getElementById('txt_id_comanda').value;
//                    alert(IdComanda);
                    $.ajax({
                    url: "./Validaciones_Lado_Servidor/N_AgregarCocinaBar.php",
                    type: 'POST',
...
//                        alert(data);
                        if(data==1)
                        {
                            swal('Correcto','Producto(s) enviado(s) a cocina','success');
                            document.getElementById("btnVMCocina").disabled = true; 
                        }
                        else{
                            swal('Error','No se pudo enviar a cocina.','error');
                        }
                ...
                $(element).next("span").addClass("glyphicon-ok").removeClass("glyphicon-remove");
                            ...
                            switch ($('#cmbStatus option:selected').text()) {
                                ...
                                function ValidarBotonCambiarEstado()
                                {
                                    ...
                                    var HayQuePagar = document.getElementById("txtHayQuePagar").value;
                                    //alert (HayQuePagar);
                                    ...
                                    if(Opcion == 2)
                                    {
                                        ...
                                        if((txtEdFPago  && txtEdMPago))
                                        {
                                            ...
                                            $("#btnAceptarM").attr("disabled", false);
                                            
                                        }
                                        else
                                        {
                                            
                                            $("#btnAceptarM").attr("disabled", true);
                                            
                                        }
                                        
                                        if(HayQuePagar=='FALSE'){
                                           $("#btnAceptarM").attr("disabled", true); 
                                        }
                                    }
                                    else
                        ...
                        <div class="modal-footer">
                            <div>
                                <button type="submit" id="btnAceptarM" class="btn btn-primary btn-lg btn-block btn-Bixa" name="btnAceptarM" onclick="" >Cambiar Estado</button>
                            </div>
