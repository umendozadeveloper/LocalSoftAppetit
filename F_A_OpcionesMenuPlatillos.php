...
$objSubMenu->ConsultarSubMenuPorID($Tipo);

?>
<title>Opciones submenús-platillos</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<input type="text" id="MenuP" value="<?php echo $Tipo;?>" class="ocultar">
...
<table class="table table-condensed table-bordered tablaPaginadoPrioridad">
    <thead>
        ...
        <tr>
            <th colspan="3"><center>Ordenar menús: 
                <?php echo $objSubMenu->Ruta;?>
            </center>
...
//                echo "<td><center>$s->Prioridad";
    ...
    <?php 
    if($objSubMenu->IdSubMenuPadre!=null){
    echo "<a href='F_A_OpcionesMenuPlatillos.php?MenuP=$objSubMenu->IdSubMenuPadre' class='btn btn-Regresar'>Menú anterior</a>";
    }
    ?>
    <br>
    <br>
