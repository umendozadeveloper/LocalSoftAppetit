    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-offset-1 col-lg-10">
        <table class="encabezadoTabla">
            <td class="tdEncabezadoTabla">
                <div><h4><center><label class="textoEncabezadoTabla">Ajuste de Salida</label></center></h4></div>
            </td>
        </table>
    </div>
     ...
     <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-lg-offset-1 col-lg-10 table-responsive">
            <table border="0" style="text-align: center;" >
                <tr>
                    ...
                    <td>Fecha: </td>
                    <td></td>
                    <td><div align="left"><input class="form-control" type="text" name="txtFecha" id="txtFecha" readonly="" style="width: 34%; text-align: center;" value="<?php echo date("d/m/Y"); ?>"/></div></td>
              ...
              <table border='0'>
                ...
                <tr>
                    ...
                    <?php
                        ...
                        $conceptos = $objConcepto->ConsultarSalidas();
...
//                    $("#DatosClientes").html(data);
       ...
       var ventas="";
       var fecha, cliente, encargado, costo_total,observaciones;
...
//                      alert("entra");
            ...
            ventas += "├" + descripcion + "─" + cantidad + "─" + costo + "─" + importe + "─" + almacen + "─" + concepto;
            
       });
               
       

//               alert(fecha+"-"+cliente+"-"+encargado+"-"+costo_total);
      
       $.ajax({
            url: "Validaciones_Lado_Servidor/Validar_RegistrarAjusteSalida.php",
