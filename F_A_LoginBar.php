   ...
   <?php
   include_once  'reedirigir.php';
   include_once   'Header.php';
   $objEmpresa = new Empresa();
   $objEmpresa->ObtenerPorID(1);
  
   $_SESSION['ScriptAdmin'] = $_SERVER['PHP_SELF'];
...
<title>Login</title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation" style="background-color: black">
        <div class="container topnav" >
            ...
            <div class="navbar-header" >
                ...
                <a class="navbar-brand topnav" href="#" style="color: white">Comandero Digital - Administrador</a>
            </div>
    ...
    <div class="intro-divider">
        <div style="height: 20px; width: 100%;" class="alert-success"> 
            <label>Derechos Reservados 2016 Grupo InterPC </label>
        </div>
    </div>
    	...
    	<div class="modal-dialog">
			<div class="modal-content">
                ...
                <div id="div-forms">
                    ...
                    <!-- Begin # Login Form -->
                    <form id="login-form" method="POST" action="Validaciones_Lado_Servidor/Validar_LoginUsuarios.php">
		                <div class="modal-body">
				    		<div id="div-login-msg">
                                ...
                                <span id="text-login-msg">Ingresar Nombre de Usuario y Contraseña</span>
                                    ...
                                    <div class='campos col-xs-12 col-sm-12 col-md-12 col-lg-12 input-group'>		<input id="login_password" class="form-control" type="password" placeholder="Password" name="txtContrasena" ></div>
                            <div class="checkbox">
                                <label>
				        ...
				        <div class="modal-footer">
                            <div>
                                <button type="submit" class="btn btn-Bixa btn-lg btn-block" name="btnAceptar" >Login</button>
                            </div>
