...
class GenerarXml {
    ...
    //               $nombrePOST = "chkComanda" . $Datos->IdComanda;
                    ...
                    if ($this->errores) {
                        ...
                        $objFacturas->Folio = $objSQL->GetScalar("SELECT MAX(ID) as ID from Facturas");
...
//                $this->objXml->GenerarPdf($fecha_hora_archivo,$this->TipoFactura);           
    ...
    function GuardarFactura($StatusFactura, $RutaCodigoQR = null, $RutaXML = null,$RutaPDF=null , $UUID=null, $objFacturas) {
        ...
        if ($objFacturas->Agregar($objFacturas->Folio, $this->objSeguridad->CurrentUserID(), $this->IdCliente, $this->IdMPago, $StatusFactura, $RutaCodigoQR, $RutaXML, $RutaPDF, $UUID, $this->TipoFactura)) {
