...
//            array_push($this->errores, "Se debe especificar el estatus del insumo");
        ...
        if($this->errores){
           ...
           $_SESSION['valObservac'] = $this->objInsumo->Observaciones;
            ...
            if($this->objInsumo->Insertar($this->objInsumo->Descripcion, $this->objInsumo->Presentacion, 
                    $this->objInsumo->IdUnidadMedida, $this->objInsumo->Contenido, $this->objInsumo->IdUMContent,
                    $this->objInsumo->IdClasificador, $this->objInsumo->StockMinimo, $this->objInsumo->StockMaximo,
                    $this->objInsumo->IdUbicacion, $this->objInsumo->Status, $this->objInsumo->Observaciones)){
                ...
                header("Location: ../F_A_DetalleInsumo.php?IdInsumo=".$this->objInsumo->ID);
            }  
            else{
                setSwalFailureMessage("Ocurrió un error, el insumo no se pudo registrar. Intente más tarde.");
                header("Location: ../F_A_Registrar_Insumo_Inventario.php");
