...
class AgregarClasificador{
    ...
    function main(){
        ...
        if(isset($_POST['txtID'])){
            $this->objClasificador->ID = $_POST['txtID'];
        }
        else{
            array_push($this->errores, "Debe seleccionar un clasificador a editar");
        }
        ...
        if($this->errores){
            ...
            if($this->objClasificador->ModificarPorID($this->objClasificador->ID, $this->objClasificador->Clave, 
                    $this->objClasificador->Descripcion, $this->objClasificador->EsBebida, $this->objClasificador->Observaciones,
                    $this->objClasificador->Estatus)){
                ...
                setSuccessMessage("Clasificador editado correctamente");
                header("Location: ../F_A_Editar_Clasificador.php?IdClasificador=".$this->objClasificador->ID);
                
            }
            
            else{
                setSwalFailureMessage("El clasificador ya existe favor ingrese otro.");
                header("Location: ../F_A_Editar_Clasificador.php?IdClasificador=".$this->objClasificador->ID);
