...
class N_EditarFondoApp {
    ...
    function main(){
        ...
        if($this->errores){
            ...
            echo "Testing...";
            echo "<br>Base Dir";
            echo  basename($_FILES['txtArchivoFondo']['name']);
            ...
            case "1":
                ...
                case "4":
                    ...
                    $this->destino = __DIR__ . '\\Uploads\\' . $_FILES["txtArchivoFondo"]["name"];
                    chmod( $this->destino, 0666);
                        if($this->foto!=""){
                            echo "<br>Foto es diferent de null";
                            if(move_uploaded_file($_FILES["txtArchivoFondo"]["tmp_name"], $this->destino)){
                                echo "<br>Copy";
                                if($this->objEmpresa->EditarFondos($this->objEmpresa->FondoAdministrador,
                                        $this->objEmpresa->FondoComensal, $this->objEmpresa->FondoMesero,
                                        $this->objEmpresa->Logo)){                                            
                                            ...
                                            echo "<br>Error en clase empresa (Editar Fondo)";
                                        }
                            }
